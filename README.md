...
* richtext item conversion: multi-level conversion of existing richtext items, e.g. to add/remove file hotspots (file icons that open file on click) or do mail merge with richtext
