...
public class JavaxMailMimeDataAccessService implements IMimeDataAccessService {
	...
	public MIMEData getMimeData(NotesNote note, String itemName) {
		try {
			MimeMessage mimeMessage = JavaxMailMIMEHelper.readMIMEMessage(note, itemName, EnumSet.of(MimeStreamOpenOptions.MIME_INCLUDE_HEADERS));
	...
	public void setMimeData(NotesNote note, String itemName, MIMEData mimeData) {
		...
		AccessController.doPrivileged((PrivilegedAction<Object>) ()->{
			...
			try {
				...
				JavaxMailMIMEHelper.writeMIMEMessage(note, itemName, mimeMsg, EnumSet.of(MimeStreamItemizeOptions.ITEMIZE_BODY));
				return null;
	...
	private void populateMIMEData(Object content, MIMEData retMimeData) throws MessagingException, IOException {
		...
		if (content instanceof Multipart) {
			...
			if (!part.isMimeType("multipart/related") &&
				...
				JavaxMailMimeBodyPartAttachment mimeAtt = new JavaxMailMimeBodyPartAttachment(part);
