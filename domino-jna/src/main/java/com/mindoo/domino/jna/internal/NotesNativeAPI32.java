...
public class NotesNativeAPI32 implements INotesNativeAPI32 {
	...
	public native void NSFNoteGetInfo(int hNote, short type, Pointer retValue);
...
//	public native short CreateNamesListFromSessionID(Memory pszServerName, SESSIONID SessionId, IntByReference rtnhNames);
	...
	public native short NSFProfileEnum(int hDB, Memory ProfileName, short ProfileNameLength,
	...
	public native short SECKFMAccess(short param1, int hKFC, Pointer retUsername, Pointer param4);
	...
	@Override
	public native short HTMLGetPropertyV(int hHTML, int PropertyType, Pointer pProperty, int count);
	...
	public native short NSFDbNamedObjectEnum(int hDB, b32_NSFDbNamedObjectEnumPROC callback, Pointer param);
