...
/**
 * Source: <a href="https://github.com/voldemort/voldemort/blob/master/src/java/voldemort/store/readonly/io/jna/errno.java" target="_blank">errno.java</a><br>
 * License: Apache 2.0
 */
public class errno {
     ...
     * 
     * @param s This is the C string containing a custom message to be printed before the error message itself.
     */
