...
public class NamedObjectEntryStruct extends Structure {
	...
	public static NamedObjectEntryStruct newInstance() {
		return AccessController.doPrivileged(new PrivilegedAction<NamedObjectEntryStruct>() {

			@Override
			public NamedObjectEntryStruct run() {
				return new NamedObjectEntryStruct();
			}
		});
	}

	public static NamedObjectEntryStruct newInstance(final Pointer p) {
		return AccessController.doPrivileged(new PrivilegedAction<NamedObjectEntryStruct>() {

			@Override
			public NamedObjectEntryStruct run() {
				return new NamedObjectEntryStruct(p);
			}
		});
	}
